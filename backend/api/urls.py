...
from school.views import CreateSchoolView, NotificationView, RegisterStudentView, StudentListView, StudentUpdateDeleteView, TransferRequestView, school_list
