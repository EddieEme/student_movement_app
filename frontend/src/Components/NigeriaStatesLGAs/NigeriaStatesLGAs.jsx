...
const lgas = {
    'Abia':['Aba North', 'Aba South', 'Arochukwu', 'Bende', 'Ikwuano', 'Isiala Ngwa North', 'Isiala Ngwa South', 'Isuikwuato', 'Obi Ngwa', 'Ohafia', 'Osisioma', 'Ugwunagbo', 'Ukwa East', 'Ukwa West', 'Umuahia North', 'Umuahia South', 'Umu Nneochi'],
       ...
       'Osun':
         ['Atakunmosa East', 'Atakunmosa West', 'Aiyedaade', 'Aiyedire', 'Boluwaduro', 'Boripe', 'Ede North', 'Ede South', 'Egbedore', 'Ejigbo', 'Ife Central', 'Ife East', 'Ife North', 'Ife South', 'Ifedayo', 'Ifelodun', 'Ila', 'Ilesa East', 'Ilesa West', 'Irepodun', 'Irewole', 'Isokan', 'Iwo', 'Obokun', 'Odo Otin', 'Ola Oluwa', 'Olorunda', 'Oriade', 'Orolu'],
       'Oyo':
...
const NigeriaStatesLGAs = ({ selectedState, onStateChange, selectedLGA, onLGAChange }) => {
  const [localGovts, setLocalGovts] = useState([]);

  const handleStateChange = (e) => {
    const state = e.target.value;
    onStateChange(state);
    setLocalGovts(lgas[state] || []);
  };

  return (
    <>
      <div className="form-group">
        <label htmlFor="state">State of Origin</label><br />
      ...
      <div className="form-group">
        ...
        <select id="lga" name="lga" value={selectedLGA} onChange={onLGAChange} disabled={!selectedState}>
